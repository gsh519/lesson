            ...
            <div class="add-form">
                <form action="" method="post">
                    ...
                    <div class="form-area">
                        ...
                        <input required type="tel" id="phone_number" name="phone_number" class="form-input" value="<?php $this->escape($this->branch->phone_number); ?>">
                    </div>

                    <!-- 並び順 -->
                    <div class="form-area">
                        <label class="label" for="sort_order">並び順<span>必須</span></label>
                        <input required type="number" step="1" min="1" id="sort_order" name="sort_order" class="form-input" value="<?php $this->escape($this->branch->sort_order); ?>">
                    </div>
