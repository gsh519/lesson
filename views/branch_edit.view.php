                ...
                <div class="add-form">
                    <form action="" method="post">
                        ...
                        <div class="form-area">
                            ...
                            <input type="text" id="phone_number" name="phone_number" class="form-input" value="<?php echo htmlspecialchars($this->branch->phone_number, ENT_QUOTES); ?>">
                        </div>

                        <!-- 並び順 -->
                        <div class="form-area">
                            <label class="label" for="sort_order">並び順<span>必須</span></label>
                            <input type="text" step="1" min="1" id="sort_order" name="sort_order" class="form-input" value="<?php echo htmlspecialchars($this->branch->sort_order, ENT_QUOTES); ?>">
                        </div>
